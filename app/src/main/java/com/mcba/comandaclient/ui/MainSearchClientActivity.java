...
public abstract class MainSearchClientActivity extends AppCompatActivity implements ISearchCallbacks {
    ...
    private MainSearchClientActivity.QueuedSearchChangeNotifier mQueuedSearchChangeNotifier;
    ...
    public abstract void goToOpenAddClient();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.activity_search_client, menu);
    ...
    private void handleSearchTermChange(String searchTerm) {
        removeQueuedSearchNotifier();
        mQueuedSearchChangeNotifier = new MainSearchClientActivity.QueuedSearchChangeNotifier(searchTerm);
